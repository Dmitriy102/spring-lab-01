...
public class ContainerReport implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("Notifier implementations: {}", Arrays.toString(context.getBeanNamesForType(Notifier.class)));
        log.info("Type of the notificationService bean: {}", context.getBean("notificationService").getClass().getName());
